    ...
    <div class = 'row'>
        <div class ='col-sm-10 col-sm-offset-1'>
            <table class = 'table table-bordered'>
                ...
                <th class="title">Player 1</th>
                <th class="title">Player 2</th>
                <th class="title">Score</th>
                <th class="title">Class 1</th>
                <th class="title">Class 2</th>


                <?php
                $result = mysqli_query($sql,
                    "SELECT * FROM team_scores ORDER BY score DESC LIMIT 10");
                $names = array();
                //$price = array();
                $score = array();
